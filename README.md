...
- 🔍 **多源发现策略** — B 站四策略（搜索 · 关联链 · 趋势 · 跨域探索，搜索冷却时可由扩展打开真实搜索页抓渲染结果兜底）+ 小红书三层安全发现 + 抖音插件签名 search / hot / feed + X 搜索 / For-You / 关注作者，跨平台协同工作
