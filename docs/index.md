...
- [国内下载（123 云盘）](https://4001474255.share.123pan.cn/123pan/IxbZMh-90KO3) — 当前 v0.3.213 的 7 个包，分享永久有效并可直接打开下载；[Gitee v0.3.213 发行版](https://gitee.com/whiteguo233/openbiliclaw/releases/tag/openbiliclaw-v0.3.213) 提供国内镜像附件与源码入口
